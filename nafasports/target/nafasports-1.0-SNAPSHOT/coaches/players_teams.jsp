<%-- 
    Document   : players_teams
    Created on : 19 Jan 2023, 10:40:25 PM
    Author     : josiah
--%>
...
//            String teamid = 
        ...
        <title>Welcome to NAFA Coach Portal:: Teams Players</title>
        <meta charset="UTF-8">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Manage Team Players</h3>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-12">
                                <div class="">
                                    <a href="<%= portal %>players_new.jsp?i=<%= email %>" class="text-decoration-none btn bg-light">
                                        <span class="fa fa-plus"></span>
                                        <span>Register New Team Player</span>
                                    </a>
                                </div>
                            </div>
                        </div>
...
//                                        String stateid = (String)request.getAttribute("stateid");
                                        String query = "select * from "+AppData.PLAYERS+" where iTeamID IN(select iTeamID from "+AppData.TEAM_COACHES+" where cCoachID = '"+coachno+"')";
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String teamids =rep.getString(2);
                                                String fullname =rep.getString(3);
                                                String emails =rep.getString(4);
                                                ...
                                                team = TeamDAO.getTeamName(teamids);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<%= portal %>players_new.jsp?i=<%= email %>" method="post">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="teamid" value="<%= teamids %>" />
