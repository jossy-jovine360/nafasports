...
function addItemsToCart(stockid, qty, topic, userid) { 
    document.getElementById("btnid"+stockid).innerHTML = "processing...";
//    var  url = "http://localhost:8080/jovine360workspace/AjaxAdminOrderCartServlet?action=addItemToCart&stockid="+stockid+"&qty="+qty+"";
    var  url = "https://www.jovine360workspace.com/AjaxAdminOrderCartServlet?action=addItemToCart&stockid="+stockid+"&qty="+qty+"";
    var xmlHttp;
    ...
    xmlHttp.onreadystatechange = function(){
        if(xmlHttp.readyState === 4 && xmlHttp.status === 200){                
            ...
            document.getElementById("btnid"+stockid).innerHTML = "Add to Cart";
