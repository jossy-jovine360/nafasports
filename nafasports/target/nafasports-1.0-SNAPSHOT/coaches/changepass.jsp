<%-- 
    Document   : changepass
    Created on : 24 Jan 2023, 4:12:19 PM
    Author     : josiah
--%>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 p-4">
                                <form action="<%= AppData.COACH_CONTROLLER_SUBDOMAIN %>chengePass" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="function" value="new" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
