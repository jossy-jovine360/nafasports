<%-- 
    Document   : team_news
    Created on : 10 Mar 2023, 7:43:51 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA | Team News</title>
        <meta charset="UTF-8">
                ...
                <div class="row p-4 mb-5" id="player-new">
                    <div class="col-12" id="contents-player">
                        ...
                        <%
                            ...
                            String query_transfer = "select * from "+AppData.NEWS+" where vCategory = 'Team'";
                            String query_tota_transfer = "";
                            total_transfer = NewsDAO.getTotalNewsSummary("Team", 8);
