...
function loadTeamsDistrictsOptions(stateid, id) { 
    
//    var  url = "http://localhost:8080/nafasports/AjaxAdminGetTeamsOptionsServlet?action=getTeamsDistrict&stateid="+stateid+"";
    var  url = "https://www.nafafootball.com/AjaxAdminGetTeamsOptionsServlet?action=getTeamsDistrict&&stateid="+stateid+"";
    var xmlHttp;
