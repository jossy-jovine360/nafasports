...
<html>
    <head>
        <%  
            ...
            if(portal.equals("admin_nafa/admin_nafa/")){
                portal = "admin_nafa/";
            }
        ...
        <title>Welcome to NAFA Administrator Login Page </title>
        <meta charset="UTF-8">
                        ...
                        <div class="col-lg-2 col-md-12 col-sm-12">
                            <span class="position-relative">
                                <a href="#" class="text-decoration-none">
                                    <img src="images/nafa_logo.png" alt="alt" class="w-150px height-150px rounded"/>
                                </a>
                            </span>
                        </div>
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <div class="width-100 height-100 d-flex align-items-center p-3">
                                <h1 class="">Welcome to NAFA Administrator Portal Login Page</h1>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="height-600px width-100">
                                            <div class="width-70 height-100 centralize d-flex align-items-center justify-content-center">
                                                <img src="images/nafa_full.png" alt="alt" class="width-100 height-90 rounded"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="textEmail" id="email" placeholder=" email /username here" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
