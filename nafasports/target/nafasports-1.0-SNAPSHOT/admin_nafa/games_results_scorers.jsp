<%-- 
    Document   : games_results_scorers
    Created on : 25 Jan 2023, 11:05:06 PM
    Author     : josiah
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <%
                            ...
                            String time = "";
                            if(flag == null){}else{
                                scoreid = request.getParameter("scoreid");
                                if(scoreid == null){
                                    scoreid = "";
                                }else{
                                    function = "edit";
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>add_scorer" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="number" class="form-control" name="quarter" id="quarter" value="<%= quarter %>" required /> 
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Select Score Time:</label>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="scoreid" id="scoreid" class="form-control" value="<%= scoreid %>" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
