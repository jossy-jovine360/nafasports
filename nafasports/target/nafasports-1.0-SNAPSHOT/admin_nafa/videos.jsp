<%-- 
    Document   : videos
    Created on : 17 Feb 2023, 7:54:51 PM
    Author     : josiah
--%>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>news_videos.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                                        <span class="fa fa-plus"></span>
                                        <span>Post New News Video</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        String query = "select * from "+AppData.NEWS_VIDEOS+" order by dtDate desc";
                                        ...
                                        if(dac.next()){
                                            ...
                                            while(dac.next()){
                                                ...
                                                String newsid = dac.getString(2);
                                                String vide = dac.getString(3);
                                                String datetime = dac.getString(4);
                                                
                                                news = NewsDAO.getNewsTitle(newsid);
                                    %>
                                    <tr>
                                        <td><%= id %></td>
                                        <td><%= news %></td>
                                        ...
                                        <td><%= datetime %></td>
                                        <td>
                                            <form action="<%= portal %>news_videos.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <button type="submit" class="btn btn-success me-2" name="function" value="edit" data-bs-title="Edit News Video" data-bs-toggle="tooltip" data-bs-placement="top">
                                                            <span class="fa fa-edit"></span>
                                                        </button>
                                                    </div>
                                                    <div class="col-6">
                                                        <a href="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>postVideo&function=delete&videoid=<%= id %>" class="text-decoration-none" data-bs-title="Delete News Video" data-bs-toggle="tooltip" data-bs-placement="top">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="videos" value="<%= vide %>" />
                                                    </div>
                                                </div>
                                            </form>
                                        </td>
