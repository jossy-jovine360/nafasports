<%-- 
    ...
    Created on : 26 Jan 2023, 6:01:44 PM
    Author     : josiah
--%>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>group_standings_update.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                ...
                                %>
                                <h3 class="bg-success bg-gradient text-white rounded p-2"><%= header %></h3>
...
//                                    Now we get the team's category from each district
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td><%= pt %></td>
                                        <td>
                                            <form action="<%= portal %>group_standings_update.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="gf" value="<%= gf %>" /> 
                                                        <input type="hidden" name="ga" value="<%= ga %>" /> 
                                                        <input type="hidden" name="gdf" value="<%= gdf %>" /> 
