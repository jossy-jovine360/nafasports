<%-- 
    Document   : districts_new
    Created on : 15 Feb 2023, 9:08:38 AM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Manage League Divisions</h3>
                            </div>
                        </div>
                        <%
                            String function = request.getParameter("function");
                            String label = "Create State District";
                            if(function == null){
                                function = "new";
                            }else{
                                label = "Save State District Changes";
                            }
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>district_new" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="district" class="form-control" id="district" value="<%= district %>" placeholder="e.g District I[...N]" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <input type="hidden" name="distid" value="<%= distid %>" class="form-control" id="divid" />
