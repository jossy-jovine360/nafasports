<%-- 
    Document   : news_videos
    Created on : 17 Feb 2023, 3:22:15 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: News Videos</title>
        <meta charset="UTF-8">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Post News Videos from Youtube</h3>
                            </div>
                        </div>
                        <%
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>postVideo" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>News:</label>
                                            <select class="form-control" name="newsid" id="newsid" required>
                                            <%
                                                LinkedHashMap link = NewsDAO.loadAllNews();
                                                if(link == null || link.isEmpty()){
                                                    out.print("<option>No news have been posted</option>");
                                                }else{
                                                    out.println("<option value=''>Select News</option>");
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <textarea id="newsVideo" name="videos" rows="5" class="form-control"><%= videos %></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <button type="button" class="btn btn-primary" id="preview-video">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="width-100" id="preview"></div>
                            </div>
                        </div>
                    </div>
                </div>
