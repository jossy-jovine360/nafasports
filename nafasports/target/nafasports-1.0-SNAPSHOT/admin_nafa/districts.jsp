                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>districts_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                                        <span class="fa fa-plus"></span>
                                        <span>Create New District</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        String query = "select * from "+AppData.DISTRICTS+" order by cStateID";
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String district =rep.getString(2);
                                                String stateid =rep.getString(3);
                                    ...
                                    <tr class="text-13px">
                                        ...
                                        <td><%= state %></td>
                                        <td>
                                            <form action="<%= portal %>districts_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <button type="submit" class="btn btn-success me-2" data-bs-title="Edit <%= district %>" data-bs-toggle="tooltip" data-bs-placement="top">
                                                            <span class="fa fa-edit"></span>
                                                        </button>
                                                        <a href="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>district_new&function=delete&distid=<%= id %>" class="text-decoration-none" data-bs-title="Delete Division: <%= district %>" data-bs-toggle="tooltip" data-bs-placement="top">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="hidden" name="distid" value="<%= id %>" />
