<%-- 
    Document   : coaches_team
    Created on : 22 Jan 2023, 3:03:35 PM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Assign Coach to Team</h3>
                            </div>
                        </div>
                        <%
                            String function = "new";
                            String label = "Assign Coach to Team";
                            String teamcoachid = request.getParameter("teamcoachid");
                            if(teamcoachid == null){
                                teamcoachid = "";
                            }else{
                                function = "edit";
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>assign_coach" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <select class="form-control" name="coachid" id="coachid" required>
                                                <%
                                                    LinkedHashMap link1 = CoachDAO.loadAllCoaches();
                                                    if(link1 == null || link1.isEmpty()){
                                                            out.println("<option value=''>You have no registered coaches</option>");
                                                    }else{
                                                        out.println("<option value=''>Select Coach</option>");
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="teamcoachid" id="user" class="form-control" value="<%= teamcoachid %>" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
