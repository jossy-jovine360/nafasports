<%-- 
    Document   : games_stats
    Created on : 19 Jan 2023, 10:55:35 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: Games Stats</title>
        <meta charset="UTF-8">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>games_stats_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                                        ...
                                        <span>Add New Game Statistics</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12"><h3>
                                <table>
                                    <tr>
                                        ...
                                        <th>Rushing Yard</th>
                                        <th>Penalties</th>
                                        <th>Penalties Yard</th>
                                        <th>Turn Overs</th>
                                        <th>Punts</th>
                                        <th>Touch Downs</th>
                                        <th>Rushing Touch Downs</th>
                                        <th>Passing Touch Downs</th>
                                        <th>Turn-over Touch Downs</th>
                                        <th>Field Goal Succeeded</th>
                                        <th>Field Goal Attempted</th>
                                        <th>Interception Thrown</th>
                                        <th>Fumbles Lost</th>
                                        <th>Sacks Allowed</th>
                                        <th>Safeties</th>
                                    ...
                                    <%
                                        String query = "";
                                        query = "select * from "+AppData.GAME_STATS+" order by iGameID";
                                        DataAccessObject dac = ReportDynaDAO.loadRecord(query);
                                        if(dac.next()){
                                            dac.previous();
                                            String game = "";
                                            String team = "";
                                            while(dac.next()){
                                                ...
                                                String gameid = dac.getString(2);
                                                String teamid = dac.getString(3);
                                                String firstdown = dac.getString(4);
                                                String totalyard = dac.getString(5);
                                                String passingyard = dac.getString(6);
                                                String rushingyard = dac.getString(7);
                                                String penalties = dac.getString(8);
                                                String penaltiesyard = dac.getString(9);
                                                String turnovers = dac.getString(10);
                                                String punts = dac.getString(11);
                                                String touchdowns = dac.getString(12);
                                                String rushingtouchdowns = dac.getString(13);
                                                String passingtouchdowns = dac.getString(14);
                                                String turnovertouchdown = dac.getString(15);
                                                String fieldgoal_succeeded = dac.getString(16);
                                                String fieldgoal_attempted = dac.getString(17);
                                                String interception_thrown = dac.getString(18);
                                                String fumblelost = dac.getString(19);
                                                String sacksallowed = dac.getString(20);
                                                String safeties = dac.getString(21);
                                                String twopoints_conversion = dac.getString(22);
                                                
                                                game = GameDAO.getGameOnly(gameid);
                                    ...
                                    <tr>
                                        ...
                                        <td><%= turnovertouchdown %></td>
                                        <td><%= fieldgoal_succeeded %></td>
                                        <td><%= fieldgoal_attempted %></td>
                                        <td><%= interception_thrown %></td>
                                        <td><%= fumblelost %></td>
                                        <td><%= sacksallowed %></td>
                                        <td><%= safeties %></td>
                                        <td><%= twopoints_conversion %></td>
                                        <td>
                                            <form action="<%= portal %>games_stats_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="hidden" name="statsid" value="<%= id %>" />
                                                        <input type="hidden" name="gameid" value="<%= gameid %>" />
                                                        <input type="hidden" name="teamid" value="<%= teamid %>" />
                                                        <input type="hidden" name="firstdown" value="<%= firstdown %>" />
                                                        <input type="hidden" name="totalyard" value="<%= totalyard %>" />
                                                        <input type="hidden" name="passingyard" value="<%= passingyard %>" />
                                                        <input type="hidden" name="rushingyard" value="<%= rushingyard %>" />
                                                        <input type="hidden" name="penalties" value="<%= penalties %>" />
                                                        <input type="hidden" name="penaltiesyard" value="<%= penaltiesyard %>" />
                                                        <input type="hidden" name="turnovers" value="<%= turnovers %>" />
                                                        <input type="hidden" name="punts" value="<%= punts %>" />
                                                        <input type="hidden" name="touchdowns" value="<%= touchdowns %>" />
                                                        <input type="hidden" name="rushingtouchdowns" value="<%= rushingtouchdowns %>" />
                                                        <input type="hidden" name="passingtouchdowns" value="<%= passingtouchdowns %>" />
                                                        <input type="hidden" name="turnovertouchdown" value="<%= turnovertouchdown %>" />
                                                        <input type="hidden" name="fieldgoal_succeeded" value="<%= fieldgoal_succeeded %>" />
                                                        <input type="hidden" name="fieldgoal_attempted" value="<%= fieldgoal_attempted %>" />
                                                        <input type="hidden" name="interception_thrown" value="<%= interception_thrown %>" />
                                                        <input type="hidden" name="fumblelost" value="<%= fumblelost %>" />
                                                        <input type="hidden" name="sacksallowed" value="<%= sacksallowed %>" />
                                                        <input type="hidden" name="safeties" value="<%= safeties %>" />
                                                        <input type="hidden" name="twopoints_conversion" value="<%= twopoints_conversion %>" />
