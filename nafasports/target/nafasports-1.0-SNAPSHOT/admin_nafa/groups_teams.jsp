<%-- 
    Document   : groups_standings
    Created on : 19 Jan 2023, 11:08:07 PM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>All Teams Assigned to Groups</h3>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>groups_teams_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                                        <span class="fa fa-plus"></span>
                                        <span>Assign Team to Group</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        String query = "select * from "+AppData.GROUP_TEAMS;
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String groupid =rep.getString(2);
                                    ...
                                    <tr>
                                        ...
                                        <td><%= group %></td>
                                        <td>
                                            <form action="<%= portal %>groups_teams_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                    <div class="col-12"  title="Edit <%= group %>">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="hidden" name="groupteamid" value="<%= id %>" />
