<%-- 
    Document   : games_lineups
    Created on : 19 Jan 2023, 10:54:55 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: Games Lineups</title>
        <meta charset="UTF-8">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Manage Games Lineups</h3>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>games_lineups_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12">
                                    <%
                                        String gameids = (String)request.getAttribute("gameid");
                                        String query = "";
                                        if(gameids == null){
                                            query = "select * from "+AppData.GAME_LINEUPS+" where iGameID IN(select iGameID from "+AppData.GAMES+" where cStatus = 'pending' order by dDate desc) group by iGameID";
                                        }else{
                                            query = "select * from "+AppData.GAME_LINEUPS+" where iGameID = '"+gameids+"'";
                                        }
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String type =rep.getString(2);
                                                String gameid =rep.getString(3);
                                                String teamid =rep.getString(4);
                                                
                                                md = GameDAO.getGameGroupNmatchDay(gameid);
                                                game = GameDAO.getGameOnly(gameid);
                                                game_time = GameDAO.getGameDateTime(gameid);
                                    %>
                                    <h6 class="text-center" ><%= md %></h6>
                                    <h5 class="text-center bg-light p-2"><%= game %></h5>
                                    <h6 class="text-center mb-3"><%= game_time %></h6>
                                    <%
                                                String hometeamid = GameDAO.getGameHomeTeam(gameid);
                                                String awayteamid = GameDAO.getGameAwayTeam(gameid);
                                                
                                                String hometeam = TeamDAO.getTeamName(hometeamid);
                                                String awayteam = TeamDAO.getTeamName(awayteamid);
                                    %>
                                    <div class="row">
                                        <div class="col-6">
                                            <h5 class="text-center bg-light p-2 rounded"><%= hometeam %></h5>
                                            <%
                                                String query_team_players = "select * from "+AppData.GAME_LINEUPS+" where iGameID = '"+gameid+"' and iTeamID = '"+hometeamid+"'";
                                                DataAccessObject play = ReportDynaDAO.loadRecord(query_team_players);
                                                if(play.next()){
                                                    play.previous();
                                                    String player = "";
                                            %>
                                            ...
                                            <%
                                                    while(play.next()){
                                                        String playerid = play.getString(5);
                                                        String formation = play.getString(6);
                                                        
                                                        player = PlayerDAO.getPlayerName(playerid);
                                            %>
                                            <tr>
                                                <td><a href="#" class="text-decoration-none text-bold text-black" title="View profile"><%= player %></a></td>
                                                <td><%= formation %></td>
                                                <td>
                                                    <form action="<%= portal %>games_lineups_new.jsp?i=<%= username %>" method="post">
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <input type="hidden" name="lineupid" value="<%= id %>" />
                                        ...
                                        <div class="col-6">
                                            <h5 class="text-center bg-color-gray p-2 text-white rounded"><%= awayteam %></h5>
                                            <%
                                                String query_team_players2 = "select * from "+AppData.GAME_LINEUPS+" where iGameID = '"+gameid+"' and iTeamID = '"+awayteamid+"'";
                                                DataAccessObject plays = ReportDynaDAO.loadRecord(query_team_players2);
                                                if(plays.next()){
                                                    plays.previous();
                                                    String player = "";
                                            %>
                                            ...
                                            <%
                                                    while(play.next()){
                                                        String playerid = plays.getString(6);
