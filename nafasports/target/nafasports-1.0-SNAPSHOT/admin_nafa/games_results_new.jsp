<%-- 
    Document   : games_results_new
    Created on : 25 Jan 2023, 8:37:43 PM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Add New Game Result</h3>
                            </div>
                        </div>
                        <%
                            String function = "new";
                            String label = "Add Game Result";
                            String fixtureid = "";
                            String matchday = "";
                            String groupid = "";
                            String hometeamid = "";
                            ...
                            if(flag == null){}else{
                                fixtureid = request.getParameter("fixtureid");
                                if(fixtureid == null){
                                    fixtureid = "";
                                }else{
                                    function = "edit";
                                    label = "Save Changes to Game Result";
                                }
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>add_Game_fixtures_result" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Match Day:</label>
                                            <div class="input-group">
                                                <span class="input-group-text">MD-</span>
                                                <input type="number" class="form-control" name="matchday" id="matchday" value="<%= matchday %>" readonly required /> 
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <select class="form-control" name="groupid" id="groupid" readonly required>
                                                <%
                                                    LinkedHashMap link1 = GroupDAO.loadAllAssignedGroups();
                                                    if(link1 == null || link1.isEmpty()){
                                                            out.println("<option value=''>You have no registered group</option>");
                                                    }else{
                                                        out.println("<option value=''>Select Group</option>");
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <select class="form-control" name="hometeamid" id="hometeamid" readonly required>
                                                <%
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <select class="form-control" name="awayteamid" id="awayteamid" readonly required>
                                                <%
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="date" class="form-control" name="date" id="date" value="<%= date %>" readonly required /> 
                                        </div>
                                    </div>     
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Match Time:</label>
                                            <input type="time" class="form-control" name="time" id="time" value="<%= time %>" readonly required /> 
                                        </div>
                                    </div>     
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="fixtureid" id="fixtureid" class="form-control" value="<%= fixtureid %>" />
                                            <input type="hidden" name="teamidh" id="fixtureid" class="form-control" value="<%= hometeamid %>" />
                                            <input type="hidden" name="teamida" id="fixtureid" class="form-control" value="<%= awayteamid %>" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
