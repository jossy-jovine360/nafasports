<%-- 
    Document   : games_results
    Created on : 22 Jan 2023, 10:11:47 AM
    Author     : josiah
--%>
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            %>
                                            <form action="<%= portal %>games_results_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                    <div class="col-12"  title="Add Result">
                                                        <button type="submit" class="btn btn-success btn-sm">
                                                            <span class="">update score</span>
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="row">
