...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: Teams</title>
        <meta charset="UTF-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>team_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="d-flex justify-content-end align-items-end">
                                    <form action="<%= portal %>teams.jsp?i=<%= username %>" method="post">
                                        <div class="width-auto">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <label for="leagueid">Select State:</label>
                                                    <select class="form-control" name="stateid" id="stateid" required>
                                                        <%
                                                            ...
                                                            if(link == null || link.isEmpty()){
                                                                ...
                                                                out.println("<option value='all'>All State</option>");
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    ...
                                                    <select class="form-control" name="districtid" id="districtid" required>
                                                        <%
                                                            LinkedHashMap link1 = DistrictDAO.loadAllDistricts();
                                                            if(link1 == null || link1.isEmpty()){
                                                                    out.println("<option value=''>You have no registered state district</option>");
                                                            }else{
                                                                out.println("<option value='all'>All Districts</option>");
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control" name="category" id="category">
                                                            <option <% if(category.equals("all")){out.print("selected='true'");} %> value="all" >All Category</option>
                                                            <option <% if(category.equals("Men")){out.print("selected='true'");} %> value="Men" >Men's Category</option>
                                                            <option <% if(category.equals("Women")){out.print("selected='true'");} %> value="Women" >Women's Category</option>
                                                        </select>
                                                        <button class="btn btn-light input-group-text" data-bs-title="click to load" data-bs-toggle="tooltip" data-bs-placement="right">
...
//                                        String query = "";
//                                        if(stateid == null){
//                                            query = "select * from "+AppData.TEAMS;
//                                        }else{
//                                            query = "select * from "+AppData.TEAMS+" where cStateID = '"+stateid+"'";
//                                        }
                                        DataAccessObject rep = null;
//                                        rep = ReportDynaDAO.loadRecord(query);
                                        rep = TeamDAO.getTeamQuery(stateid, districtid, category);
                                        if(rep.next()){
                                            rep.previous();
                                            String state = "";
                                            ...
                                            while(rep.next()){
                                                ...
                                                String team =rep.getString(2);
                                                String code =rep.getString(3);
                                                String statecode =rep.getString(4);
                                                String gender =rep.getString(5);
                                                String logo =rep.getString(6);
                                                String distid =rep.getString(7);
                                                state = StateDAO.getStateName(statecode);
                                                path = domain+"images/emblem/"+logo;
                                    ...
                                    <tr>
                                        ...
                                        <td><%= gender %></td>
                                        <td>
                                            <a href="#" class="text-decoration-none"><img src="<%= path %>" class="img-circle" alt="alt"/></a>
                                        </td>
                                        <td>
                                            <form action="<%= portal %>team_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="stateid" value="<%= statecode %>" />
