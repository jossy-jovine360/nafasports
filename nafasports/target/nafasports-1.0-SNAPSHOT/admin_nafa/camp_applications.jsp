<%-- 
    Document   : camp_applications
    Created on : 18 Mar 2023, 7:18:46 AM
    Author     : josiah
--%>
                                ...
                                <table class="table table-responsive table-striped">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            String query = "select * from "+AppData.CAMPS+" where cStatus = 'tobe Procesed'";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="camp_application_view.jsp" method="post">
