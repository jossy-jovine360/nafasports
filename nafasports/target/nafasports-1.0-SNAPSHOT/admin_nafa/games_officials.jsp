<%-- 
    Document   : games_officials
    Created on : 23 Jan 2023, 4:51:11 PM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Manage Games Officials</h3>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>games_official_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String fullname =rep.getString(2);
                                                String email =rep.getString(3);
                                                String phone =rep.getString(4);
                                                String address =rep.getString(5);
                                                String designation =rep.getString(6);
                                                String date =rep.getString(7);
                                    ...
                                    <tr class="text-13px">
                                        ...
                                        <td><%= date %></td>
                                        <td>
                                            <form action="<%= portal %>games_official_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <button type="submit" class="btn btn-success me-2" data-bs-title="Edit <%= fullname %>" data-bs-toggle="tooltip" data-bs-placement="top">
                                                            <span class="fa fa-edit"></span>
                                                        </button>
<!--                                                        <a href="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>LeagueNew&function=close&leagueid=<%= id %>" class="text-decoration-none" data-bs-title="Close League: <%= fullname %>" data-bs-toggle="tooltip" data-bs-placement="top">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="hidden" name="officialid" value="<%= id %>" />
