<%-- 
    ...
    Created on : 22 Jan 2023, 3:22:15 PM
    Author     : josiah
--%>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>coaches_team_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                                        <span class="fa fa-plus"></span>
                                        <span>Assign Team to Coach</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        String query = "select * from "+AppData.TEAM_COACHES;
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String coachid =rep.getString(3);
                                                
                                                coach = CoachDAO.getCoachName(coachid);
                                    ...
                                    <tr>
                                        ...
                                        <td><%= coach %></td>
                                        <td>
                                            <form action="<%= portal %>coaches_team_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                    <div class="col-12"  title="Edit <%= coach %>">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="hidden" name="teamcoachid" value="<%= id %>" />
