<%-- 
    Document   : transfer_news
    Created on : 10 Mar 2023, 1:55:50 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <meta name="description" content="NAFA Transfer News">
                ...
                <div class="row p-4 mb-5" id="transfer-new">
                    <div class="col-12" id="contents-transfer">
                        ...
                        <%
                            ...
                            String query_transfer = "select * from "+AppData.NEWS+" where vCategory = 'Transfer'";
