<%-- 
    Document   : players_news
    Created on : 10 Mar 2023, 2:11:59 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <meta name="description" content="NAFA Players News">
    ...
    <body>
        ...
        <section class="bg-light p-5 height-120px" id="navigation-banner">
            <div class="centralize w-50 text-center text-bold"><a href="/" class="text-decoration-none">Home</a> / <a href="news.jsp" class="text-decoration-none">News</a> / Transfers</div>
        </section>
        <section>
            <div class="container">
                <div class="row p-4 mb-5" id="player-new">
                    <div class="col-12" id="contents-player">
                        <h4 class="p-3 mb-3">Player News</h4>
                        <%
                            int total_transfer = 0;
                            String query_transfer = "select * from "+AppData.NEWS+" where vCategory = 'Player'";
                            String query_tota_transfer = "";
                            total_transfer = NewsDAO.getTotalNewsSummary("Player", 8);
