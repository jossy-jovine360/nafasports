 ...
 * @author josiah
 */
public class PlayersTeamNewServlet extends HttpServlet {
...
//                todo output your page here
                    ...
                    case "new":{
                        ...
                        if(check_player == 0){
                            ...
                            if(conn_add == null){
                                ...
                                dac.setColumnValues(playerid, teamid, fullname, email, phone, gender, dob, address, stateid, grade, position, height, weight, special, remark, date,"player_profile.png");
                                ...
                                if(add == 0){
                                    ...
                                    getServletContext().getRequestDispatcher("/admin_nafa/players_teams.jsp?username="+username).forward(request, response);
                                }else{
                                    request.setAttribute("portal", "1");
                    ...
                    case "edit":{
                        ...
                        if(conn_edit == null){
                            conn_edit = Konnect.getNAFAConnection();
                             ...
                             dac.setColumnValues(teamid, fullname, email, phone, gender, dob, address, stateid, grade, position, height, weight, special, remark);
                             ...
                             if(edit == 0){
                                ...
                                getServletContext().getRequestDispatcher("/admin_nafa/players_teams.jsp?i="+username).forward(request, response);
                             }else{
                                request.setAttribute("portal", "1");
                                request.setAttribute("msg", "Player's Changes coauld not be saved successfully. kindly ensure the correct info is submitted.");
                                getServletContext().getRequestDispatcher("/admin_nafa/players_new.jsp?i="+username).forward(request, response);
                             }
                        }
                        conn_edit.close();
                        break;
            ...
            Logger.getLogger(PlayersTeamNewServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
