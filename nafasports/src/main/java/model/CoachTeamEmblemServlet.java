 ...
 * @author josiah
 */
public class CoachTeamEmblemServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!isMultipart) {
                ...
                getServletContext().getRequestDispatcher("/coaches/teams_brand.jsp?i="+username).forward( request,  response);
            } else {
