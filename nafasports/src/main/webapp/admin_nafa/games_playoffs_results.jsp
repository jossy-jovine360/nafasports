<%-- 
    Document   : games_playoffs_results
    Created on : 18 Feb 2023, 6:34:01 PM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Games Play-offs Fixtures</h3>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>games_playoffs_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                                        <span class="fa fa-plus"></span>
                                        <span>Create Game Play-offs Fixture</span>
                                    </a>
                                </div>
                            </div>
                        </div>
...
//                                    Now we get the districts available in those states ...
                                                    String query_district  = "select * from "+AppData.GROUPS+" where cLeagueID = '"+id+"' and cStateID = '"+stateid+"' group by iDistrict";
                                ...
                                %>
                                <h5 class="text-center bg-light rounded-2 p-2"><%= district %> </h5>
                                <%
                                                            }
//                                    Now we get the team's category from each district
                                %>
                                <h6 class=" p-2 bg-light"><%= cate %>'s Playoffs Fixtures</h6>
                                <%                           
                                                            String query_teams = "select * from "+ AppData.GAMES_PLAYOFFS+" where cStatus = 'open'";
                                ...
                                <%
                                                                ...
                                                                while(dac_teams.next()){
                                                                    String playid = dac_teams.getString(1);
                                                                    String gamewid = dac_teams.getString(2);
                                                                    String teamhomeid = dac_teams.getString(3);
                                                                    String homescore = dac_teams.getString(4);
                                                                    String gamelid = dac_teams.getString(5);
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td><%= status %></td>
                                        <td>
                                            <form action="<%= portal %>games_playoffs_results_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                    <div class="col-12"  data-bs-title="Add Result" data-bs-toggle="tooltip" data-bs-placement="top">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="hidden" name="playoffid" value="<%= playid %>" />
                                                        <input type="hidden" name="gamewid" value="<%= gamewid %>" />
                                                        <input type="hidden" name="gamelid" value="<%= gamelid %>" />
