...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: Coaches</title>
        <meta charset="UTF-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-12">
                                <div class="">
                                    <a href="<%= portal %>coaches_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
...
//                                        String stateid = (String)request.getAttribute("stateid");
                                        String query = "select * from "+AppData.COACHES;
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String pass =rep.getString(5);
                                                String address =rep.getString(6);
                                    ...
                                    <tr>
                                        ...
                                        <td><%= date %></td>
                                        <td>
                                            <form action="<%= portal %>coaches_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="hidden" name="coachno" value="<%= id %>" />
