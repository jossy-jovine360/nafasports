<%-- 
    Document   : games_fixtures_new
    Created on : 22 Jan 2023, 10:36:39 AM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Add New Game Fixture</h3>
                            </div>
                        </div>
                        <%
                            String function = "new";
                            String label = "Create Game Fixture";
                            String fixtureid = "";
                            String matchday = "";
                            String groupid = "";
                            String hometeamid = "";
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>add_Game_fixtures" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Match Day:</label>
                                            <div class="input-group">
                                                <span class="input-group-text">MD-</span>
                                                <input type="number" class="form-control" name="matchday" id="matchday" value="<%= matchday %>" required /> 
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="row mb-3">
