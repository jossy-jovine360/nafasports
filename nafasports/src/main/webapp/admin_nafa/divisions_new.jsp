<%-- 
    Document   : divisions_new
    Created on : 13 Feb 2023, 5:20:05 PM
    Author     : josiah
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <%
                            ...
                            String label = "Create League Division";
                            if(function == null){
                                function = "new";
                            }else{
                                label = "Save League Division Changes";
                            }
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>league_division" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="division" class="form-control" id="division" value="<%= division %>" placeholder="e.g Division I[...N]" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <input type="hidden" name="divid" value="<%= divid %>" class="form-control" id="divid" />
