<%-- 
    Document   : coaches_new
    Created on : 20 Jan 2023, 6:13:57 AM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <%
                            String function = "new";
                            String label = "Add New Coach";
                            String coachno = request.getParameter("coachno");
                            if(coachno == null){
                                coachno = "";
                            }else{
                                function = "edit";
                                label = "Save Coach Info";
                            }
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>add_new_coach" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Address:</label>
                                            <textarea class="form-control" rows="3" name="address" id="address" required ><%= address %></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="coachno" id="coachno" class="form-control" value="<%= coachno %>" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
