            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Manage Teams Brand</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>teamEmble_ms" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Select team emblem to upload:</label>
