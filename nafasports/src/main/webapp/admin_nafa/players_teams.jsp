...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: Teams Players</title>
        <meta charset="UTF-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-12">
                                <div class="">
                                    <a href="<%= portal %>players_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
...
//                                        String stateid = (String)request.getAttribute("stateid");
                                        String query = "select * from "+AppData.PLAYERS;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<%= portal %>players_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
