<%-- 
    Document   : groups
    Created on : 21 Jan 2023, 6:49:15 AM
    Author     : josiah
--%>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>groups_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                                        <span class="fa fa-plus"></span>
                                        <span>Add League Group</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        String query = "select * from "+AppData.GROUPS;
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String districtid =rep.getString(4);
                                                String group =rep.getString(5);
                                    ...
                                    <tr>
                                        ...
                                        <td><%= district %></td>
                                        <td>
                                            <form action="<%= portal %>groups_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
