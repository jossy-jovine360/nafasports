<%-- 
    Document   : games_official_new
    Created on : 23 Jan 2023, 4:48:55 PM
    Author     : josiah
--%>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-12 p-0 hidden-print">
                        ...
                        <%
                            ...
                            String label = "Create New Official";
                            if(function == null){
                                function = "new";
                            }else{
                                label = "Save Official Changes";
                            }
                            String officialid = request.getParameter("officialid");
                            if(officialid == null){
                                officialid = "";
                            }
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Add New Game Official</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>GAmes_Official" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Full Name:</label>
                                            <input type="text" name="fullname" class="form-control" value="<%= fullname %>" placeholder="enter full name here" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Email:</label>
                                            <input type="email" name="email" class="form-control" value="<%= email %>" placeholder="enter email here" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Phone:</label>
                                            <input type="number" name="phone" class="form-control" value="<%= phone %>" placeholder="enter phone here" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Address:</label>
                                            <textarea id="address" name="address" rows="3" class="form-control" placeholder="address here"><%= address %></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <%
                                                LinkedHashMap link = OfficialDAO.loadAllOfficialsDesignations();
                                                if(link == null || link.isEmpty()){
                                            %>
                                            <input type="text" name="designation" class="form-control" placeholder="enter designation" value="<%= designation %>">
                                            <%    
                                                }else{
                                                    out.println("<select name='designation' id='designation' class='form-control' required>");
                                                    out.println("<option value='specify'>Specify Designation</option>");
                                    ...
                                    <div class="row mb-3 display-none" id="specify">
                                        <div class="col-12">
                                            <label>Specify Designation:</label>
                                            <input type="text" name="designation2" class="form-control" value="" placeholder="enter designation here" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <input type="hidden" name="officialid" value="<%= officialid %>" class="form-control" id="officialid" />
                                            <input type="hidden" name="function" value="<%= function %>" class="form-control" id="function" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
