<%-- 
    Document   : groups_teams_new
    Created on : 21 Jan 2023, 10:10:53 PM
    Author     : josiah
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <%
                            String function = "new";
                            String label = "Assign Team to Group";
                            ...
                            String groupteamid = request.getParameter("groupteamid");
                            if(groupteamid == null){
                                groupteamid = "";
                            }
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>assign_team" method="post">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Select Group:</label>
                                            <select class="form-control" name="groupid" id="groupid" required>
                                                <%
                                                    LinkedHashMap link1 = GroupDAO.loadAllGroups();
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="groupteamid" id="user" class="form-control" value="<%= groupteamid %>" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
