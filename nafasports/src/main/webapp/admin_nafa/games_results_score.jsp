<%-- 
    Document   : games_results_score
    Created on : 26 Jan 2023, 2:49:26 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: Games Scores</title>
        <meta charset="UTF-8">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Manage Games Scores Stats</h3>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>games_results_scorers.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                                        <span class="fa fa-plus"></span>
                                        <span>Add New Game Score</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        ...
                                        String query = "";
                                        if(gameids == null){
                                            query = "select * from "+AppData.GAME_SCORES_STATS+" order by iGameID";
                                        }else{
                                            query = "select * from "+AppData.GAME_SCORES_STATS+" where iGameID = '"+gameids+"'";
                                        }
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String gameid =rep.getString(2);
                                                String teamid =rep.getString(3);
                                                String playerid =rep.getString(4);
                                                String quarter =rep.getString(5);
                                                String time =rep.getString(6);
                                    ...
                                    <tr>
                                        ...
                                        <td><%= time %></td>
                                        <td>
                                            <form action="<%= portal %>games_results_scorers.jsp?i=<%= username %>" method="post">
                                                <div class="row">
