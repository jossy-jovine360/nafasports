                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <div class="">
                                    <a href="<%= portal %>divisions_new.jsp?i=<%= username %>" class="text-decoration-none btn bg-light">
                        ...
                        <div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        String query = "select * from "+AppData.DIVISIONS+" order by cLeagueID";
                                        ...
                                        if(rep.next()){
                                            ...
                                            while(rep.next()){
                                                ...
                                                String leagueid =rep.getString(2);
                                                String division =rep.getString(3);
                                                
                                                league = LeagueDAO.getLeagueName(leagueid);
                                                tourn = LeagueDAO.getLeagueTournament(leagueid);
                                    %>
                                    <tr class="text-13px">
                                        <td><%= id %></td>
                                        <td><%= tourn %></td>
                                        ...
                                        <td><%= division %></td>
                                        <td>
                                            <form action="<%= portal %>divisions_new.jsp?i=<%= username %>" method="post">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <button type="submit" class="btn btn-success me-2" data-bs-title="Edit <%= division %>" data-bs-toggle="tooltip" data-bs-placement="top">
                                                            <span class="fa fa-edit"></span>
                                                        </button>
                                                        <a href="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>league_division&function=delete&divid=<%= id %>" class="text-decoration-none" data-bs-title="Delete Division: <%= division %>" data-bs-toggle="tooltip" data-bs-placement="top">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="hidden" name="divid" value="<%= id %>" />
