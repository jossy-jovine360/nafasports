<%-- 
    Document   : admin_user_new
    Created on : 1 Nov 2022, 12:21:32 AM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: New Admin User</title>
        <meta charset="UTF-8">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <%
                            String function = "add";
                            String label = "register new admin";
                            String emails = request.getParameter("email");
                            String roleid = "";
                            if(emails == null){
                                emails = "";
                            }else{
                                roleid = AdminDAO.getAdminRoleID(emails);
                            }
                            ...
                            if(last == null){
                                ...
                                function = "edit";
                                label = "save admin changes";
                            }
                        %>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>addAdmin_New" method="post">
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <label>Email:</label>
                                            <input type="email" class="form-control" name="textEmail" id="email" value="<%= emails %>" placeholder="enter email here" />
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>First Name:</label>
                                            <input type="text" class="form-control" name="textFirstName" id="firstname" value="<%= first %>" placeholder="enter first name here" />
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Last Name:</label>
                                            <input type="text" class="form-control" name="textLastName" id="lastname" value="<%= last %>" placeholder="enter last name here" />
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <label for="roleid">Admin Role:</label>
                                            <select class="form-control" name="comboRole" id="roleid" required>
                                                <%
                                                    LinkedHashMap link = AdminRoleDAO.loadAllAdminRoles();
                                                    if(link == null || link.isEmpty()){
                                                            out.println("<option value=''>You have no registered admin roles</option>");
                                                    }else{
                                                        out.println("<option value=''>Select Admin role</option>");
                                                        Set keys = link.keySet();
                                                        Iterator itr = keys.iterator();
                                                        for(int i = 0; i < keys.size(); i++){
                                                            String ids = itr.next().toString();
                                                            String names = link.get(ids).toString();
                                                            out.println("<option value = '"+ ids +"'");  
                                                            if(roleid.equals(ids)){
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="emailid" value="<%= emails %>" />
                                    </div>
                                </form>
                            </div>
