<%-- 
    Document   : group_standings_update
    Created on : 26 Jan 2023, 6:17:17 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: Games Officials</title>
        <meta charset="UTF-8">
        ...
        <script type="text/javascript" src="js/option_loader.js"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#leagueid").change(function (){
                    ...
                    loadGameTeamsOptions(leagueid, "groupteamid");
                });
            });
            /*
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Update Group Standings</h3>
                            </div>
                        </div>
                                    <%
                            String function = "new";
                            String label = "Update Group Standing";
                            ...
                            if(flag == null){}else{
                                ...
                                gtid = request.getParameter("gtid");
                                if(gtid == null){
                                    gtid = "";
                                }
                                gp = request.getParameter("gp");
                                if(gp == null){
                                    gp = "";
                                }
                                gw = request.getParameter("gw");
                                if(gw == null){
                                    gw = "";
                                }
                                ...
                                gdf = request.getParameter("gdf");
                                if(gdf == null){
                                    gdf = "";
                                }
                                pts = request.getParameter("pt");
                                if(pts == null){
                                    pts = "";
                                }
                            }
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <form action="<%= AppData.ADMIN_CONTROLLER_SUBDOMAIN %>update_standing" method="post">
                                    <div class="row mb-3">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Select League:</label>
                                            <select class="form-control" name="leagueid" id="leagueid" required>
                                                <%
                                                    LinkedHashMap link1 = LeagueDAO.loadAllLeagues();
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <select class="form-control" name="groupteamid" id="groupteamid" required>
                                                <%
                                                    LinkedHashMap link = GroupTeamDAO.loadAllGroupTeams(leagueid);
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <input type="number" min="0" class="form-control" name="gp" id="gp" value="<%= gp %>" required />
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Games Won:</label>
                                            <input type="number" min="0" class="form-control" name="gw" id="gw" value="<%= gw %>" required />
                                        </div>
                                    </div>   
                                    <div class="row mb-3">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Games Drawn:</label>
                                            <input type="number" min="0" class="form-control" name="gd" id="gd" value="<%= gd %>" required />
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Games Lost:</label>
                                            <input type="number" min="0" class="form-control" name="gl" id="gl" value="<%= gl %>" required />
                                        </div>
                                    </div>   
                                    <div class="row mb-3">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Goals Scored:</label>
                                            <input type="number" min="0" class="form-control" name="gf" id="gf" value="<%= gf %>" required />
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Goals Conceded:</label>
                                            <input type="number" min="0" class="form-control" name="ga" id="ga" value="<%= ga %>" required />
                                        </div>
                                    </div>   
                                    <div class="row mb-3">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Goal Difference (Current):</label>
                                            <input type="number" min="0" class="form-control" name="gf" id="gdf" value="<%= gdf %>" readonly required />
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <label>Points:</label>
                                            <input type="number" min="0" class="form-control" name="pts" id="pts" value="<%= pts %>" required />
                                        </div>
                                    </div>   
                                    <div class="row mb-3">
                                        <div class="col-12">
