<%-- 
    Document   : schdules
    Created on : 17 Mar 2023, 8:08:33 PM
    Author     : josiah
--%>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <%
                                ...
                                if(leagueid == null){
                                    query = "select * from "+AppData.GAMES+" where cGroupID IN(select cGroupID from "+AppData.GROUPS+" where cLeagueID = (select cLeagueID from "+AppData.LEAGUES+"  order by vLeagueName asc limit 0,1)) order by dDate asc";
                                }else{
