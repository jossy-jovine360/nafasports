<%-- 
    Document   : latest_news
    Created on : 10 Mar 2023, 7:52:14 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA | Latest News</title>
        <meta charset="UTF-8">
                ...
                <div class="row p-4 mb-5" id="player-new">
                    <div class="col-12" id="contents-player">
                        ...
                        <%
                            ...
                            String query_transfer = "select * from "+AppData.NEWS+" where vCategory = 'Latest'";
                            String query_tota_transfer = "";
                            total_transfer = NewsDAO.getTotalNewsSummary("Latest", 8);
