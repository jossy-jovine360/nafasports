...
//    var  url = "http://localhost:8080/jovine360workspace/AjaxSessionServlet?action=checkSession";
    ...
    var  domain = "https://www.jovine360workspace.com/ims/logout.jsp?username="+username;
    var  url = "https://www.jovine360workspace.com/AjaxSessionServlet?action=checkSession";
    var xmlHttp;
...
//    var  url = "http://localhost:8080/jovine360workspace/AjaxSessionServlet?action=checkSession";
    ...
    var  domain = "https://www.jovine360workspace.com/logout.jsp?email="+email;
    var  url = "https://www.jovine360workspace.com/AjaxSessionServlet?action=checkSession";
    var xmlHttp;
    if(window.XMLHttpRequest){
        xmlHttp = new XMLHttpRequest();
