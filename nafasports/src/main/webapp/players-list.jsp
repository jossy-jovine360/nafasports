<%-- 
    Document   : players-list
    Created on : 8 Mar 2023, 2:28:29 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA | All Players</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section id="menu-bar" class="sticky-lg-top">
            ...
            <section class="bg-light p-5 height-120px" id="navigation-banner">
                <div class="centralize w-50 text-center text-bold"><a href="/" class="text-decoration-none">Home</a> / Players</div>
            </section>
            <section class="p-5">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12">
                            <div class="row mb-5">
                                <div class="col-12"><h3>Players List</h3></div>
                            </div>
                            <div class="row mb-5">
                                <div class="col-12">
                                    <form action="players-list.jsp" method="post" class="d-flex justify-content-end">
                                        <div class="w-400px">
                                            <div class="row">
                                                <div class="col-12 ">
                                                    <div class="input-group">
                                                        <input type="text" name="playerName" class="form-control" placeholder=" type name here to search" />
                            ...
                            <%
                                ...
                                int total = 0;
                                if(playerName == null){
                                    query = "select * from "+AppData.PLAYERS+" order by vFullName asc";
                                    total = PlayerDAO.getTotalPlayers();
                                }else{
                                    query = "select * from "+AppData.PLAYERS+" where vFullName like '%"+playerName+"%' order by vFullName asc";
                                    String query_total = "select COUNT(cPlayerID) from "+AppData.PLAYERS+" where vFullName like '%"+playerName+"%'";
                                    total = CounterDAO.CountCustomRecordsWithCOUNT(query_total);
                                }
    ...
    //                                    String date =rep.getString(16);
                            ...
                            <%            
                                ...
                                <a href="players_profile.jsp?id=<%= id %>" class="text-decoration-none text-black">
                            ...
                            %>
                            <div class="p-2">
                                No player(s) record found for the query: "<%= playerName %>"
                            </div>
                            <%
                                }
                            %>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                ...
                                <div class="row p-4 mb-5" id="featured-new">
                                    <div class="col-12" id="contents-featured">
                                        <h4 class=" mb-3">Team News</h4>
                                        <%
                                            int total_feat = 0;
                                            String query_feat = "select * from "+AppData.NEWS+" where vCategory = 'Team' and (vTitle like '"+team+"' or vMessageParOne like '%"+team+"%' or vMessageParTwo like '%"+team+"%' or vMessageParThree like '%"+team+"%') limit 0,4";
                                            String query_tota_feat = "select COUNT(iNewsID) from "+AppData.NEWS+" where vCategory = 'Team' and (vTitle like '"+team+"' or vMessageParOne like '%"+team+"%' or vMessageParTwo like '%"+team+"%' or vMessageParThree like '%"+team+"%') limit 0,4";
                                            total_feat = CounterDAO.CountCustomRecordsWithCOUNT(query_tota_feat);
