<%-- 
    Document   : match_news
    Created on : 10 Mar 2023, 7:46:39 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA | Match News</title>
        <meta charset="UTF-8">
                ...
                <div class="row p-4 mb-5" id="player-new">
                    <div class="col-12" id="contents-player">
                        ...
                        <%
                            ...
                            String query_transfer = "select * from "+AppData.NEWS+" where vCategory = 'Match'";
                            String query_tota_transfer = "";
                            total_transfer = NewsDAO.getTotalNewsSummary("Match", 8);
...
s                                        <div class="block p-4 mb-3"><%= Ellipsis.content(title, 80) %></div>
