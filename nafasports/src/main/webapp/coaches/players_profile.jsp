<%-- 
    ...
    Created on : 10 Mar 2023, 12:10:12 PM
    Author     : josiah
--%>
...
<html>
    <head>
        ...
        <title>Welcome to NAFA Admin Portal:: Teams Brand</title>
        <meta charset="UTF-8">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pt-3">
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <h3>Manage Players Profile</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <form action="<%= AppData.COACH_CONTROLLER_SUBDOMAIN %>playerProfile_ms" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Select Team:</label>
                                            <select class="form-control" name="playerid" id="playerid">
                                                <%
                                                    LinkedHashMap link = CoachDAO.loadAllCoachesTeamsPlayers(coachno);
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label>Select player profile to upload:</label>
                                            <input type="file" class="form-control" name="emblem" id="emblem" value="" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="d-grid">
